    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Ehliyet Sinav Sorgu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/panel">SorguPro</a></li>
                        <li class="breadcrumb-item active">Ehliyet Sinav Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Ehliyet Sinav Sorgu</h4>
                </div><!-- end card header -->
            ...
            success: function(res) {
                if (res && res.data) {
                    ...
                    res.data.forEach(element => {
                        let tckn = element.tckn || "Bulunamadı";
                        let snvad = element.snvad || "Bulunamadı";
                        let tar = element.tar || "Bulunamadı";
                        let puan = element.puan || "Bulunamadı";
                        let durum = element.durum || "Bulunamadı";
                        result += `<tr>
            <td>${tckn}</td>
            <td>${snvad}</td>
            <td>${tar}</td>
