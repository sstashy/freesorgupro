                        ...
                        <div class="card-body bg-marketplace d-flex">
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    <a href="https://t.me/SorguProDuyuru" class="btn btn-primary">Telegram Adresimiz
                                    </a>
                                </div>
                            </div>
                            <img src="<?=SITEURL?>sorgupro.png" width="144" height="148" alt="" id="small-logo"
                                class="img-fluid" />
                            <style>
                                #small-logo:hover {
                                    transition: 500ms;
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                    data-target="<?= $svCount ?>">25</span> Aktif Hizmet</h2>
                        </div>
                        <div>
                            <div class="avatar-sm flex-shrink-0">
