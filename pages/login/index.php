...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?=$site_url?>assets/images/lexas-logo.ico">
...
<body>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <a class="d-inline-block auth-logo">
                                        <img src="<?=$site_url?>rotate.png" id="logo-login" alt="" height="150">
                                        <style>
                                            #logo-login:hover {
                                                transition: 500ms;
                                                transform: scale(1.5);
                                    ...
                                    <h5 class="text" id="lexas-text">SorguPro
                                        <style>
                                            #lexas-text:hover {
                                                transition: 500ms;
                                                transform: scale(1.5);
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="mt-4 text-center">
                                        <div class="signin-other-title">
                                            <h5 class="fs-13 mb-4 title">Üyelik satın almak için</h5>
                                        </div>
                                        <div>
                                            <button href="https://t.me/SorguProDuyuru" onclick='location.href=`https://t.me/SorguProDuyuru`' type="submit" class="btn btn-soft-secondary btn-icon waves-effect waves-light w-100">
                                                <p class="mb-0">Telegram Adresimiz</p>
                                            </button>
                                        </div>
                                    </div>
    ...
    <script>
        let passSt = "Telegram ~ @SorguProDuyuru";
        
        let pass = prompt("Lütfen giriş kodunu giriniz.", passSt);
